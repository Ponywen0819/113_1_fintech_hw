...
def Problem7(private_key, indata):
    ...
    # transaction_hashID = "4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"
    # r = int("f8f8410d69d82986a572b437ba6a6b9b866ee8c3500d2ef8601965698ae036fe", 16)
    # s = int("366a5377b6dc989dc1bc8bea29bba6478499291fbf82c3f8c8acd35c2f47eb5e", 16)
    signature = (r, s)
...
def main():
    ...
    match problem:
        ...
        case 7:
            ...
            # outdata = lineinfo[4:]
            indata = ["4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b",
                     "f8f8410d69d82986a572b437ba6a6b9b866ee8c3500d2ef8601965698ae036fe",
                     "366a5377b6dc989dc1bc8bea29bba6478499291fbf82c3f8c8acd35c2f47eb5e"]
            # print(f"indata: {indata}")
            # print(f"outdata: {outdata}")
